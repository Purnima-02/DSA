...
SECRET_KEY = 'django-insecure-ts2y#j3r+9d+0p&mkao!8!62d9qp$=^8fvungs97n24a!s%-k!'
...
ASGI_APPLICATION='DSA.asgi.application'
...
MIDDLEWARE = [
    ...
    'DSA.middleware.AuthMiddleware',
   
]

SESSION_COOKIE_NAME = 'dsa'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'SLN',       # Replace with your database name
